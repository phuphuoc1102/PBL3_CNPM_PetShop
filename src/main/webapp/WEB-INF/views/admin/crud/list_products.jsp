			...
			<div class="table-wrapper">
						 ...
						 <c:forEach var="products" items="${ProductPaginate}">
							<tr>
								...
								<td><a
									...
									href="<c:url value="/home/chinh-sua-thong-tin-san-pham/${products.product_id}"/>"
									class="edit" title="Edit" data-toggle="tooltip"><i
										class="material-icons">&#xE254;</i></a> <a
									href="<c:url value="/home/xoa-san-pham/${products.product_id}"/>"
				...
				<div class="clearfix">
					...
					<c:if test="${loop.index==pageinfo.currentPage}">
						<li class="page-item active"><a href="<c:url value="/home/danh-sach-san-pham/${item_id}/${type_id}/${loop.index}"/>" class="page-link">${loop.index }</a></li>
						</c:if>
						<c:if test="${loop.index!=pageinfo.currentPage}">
						<li class="page-item"><a href="<c:url value="/home/danh-sach-san-pham/${item_id}/${type_id}/${loop.index}"/>" class="page-link">${loop.index }</a></li>
						</c:if>
						</c:forEach>
					</ul>
				</div>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				 <form:form action="/petshop-test/home/them-san-pham" method="POST"
