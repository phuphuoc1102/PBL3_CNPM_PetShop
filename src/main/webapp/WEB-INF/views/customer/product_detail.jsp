        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src='<c:url value="${product.img}"/>' alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="<c:url value="/add-to-cart/${product.product_id}"/>" class="btn btn-sm text-dark p-0"><i
                ...
                <c:forEach var="item" items="${productByCategory}">
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                           <a href="<c:url value="/chi-tiet-san-pham/${product.product_id}"/>"> <img class="img-fluid w-100" src="${item.img}" alt=""></a>
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                           <a href="<c:url value="/chi-tiet-san-pham/${product.product_id}"/>"> <h6 class="text-truncate mb-3">${item.product_name}</h6></a>
