        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody id="deletecart" class="align-middle">
                    <c:forEach var="item" items="${cart}">
                        <tr>
                            ...
                            <input type="submit" value="Cập nhật" data-id="${item.key}" class="edit-quantity" >
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input id="quantity-cart-${item.key}" type="text" class="form-control form-control-sm bg-secondary text-center" value="${item.value.quantity}">
                                    <div class="input-group-btn">
    ...
    <content tag="script">
     ...
     function deleteCart(product_id) {
         $.ajax({
             ...
             type: "get",
             success: function () {
                 $("#deletecart").load(location.href + " #deletecart>*","");
             }
         });
     }
